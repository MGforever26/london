window.LONDON_DATA = {
  ...
  days: [
    {
      ...
      c: "d10",
      items: [
        ["Eftermiddag", "Ankomst til London", "Fly København 13.55 til Gatwick 14.55. Thameslink fra Gatwick Airport til London Bridge. Køb børnebilletter til begge børn i Gatwick. De voksne bruger contactless/pay as you go.", "Thameslink fra Gatwick Airport til London Bridge. I Gatwick løser vi kun børnenes togbilletter, ikke Oyster til den 12-årige. Ved London Bridge Underground køber vi Oyster til den 12-årige, får Young Visitor discount lagt på og fylder ca. £10 på.", "Zone 1-2 er fint til de almindelige London-ture, men Gatwick og Watford/Harry Potter ligger udenfor og håndteres særskilt.", [["Thameslink", "thames1"], ["Hotel", "map:Premier Inn London Tower Bridge"], ["Oyster", "tflOyster"]]],
    ...
    },
    {
      ...
      items: [
        ...
        ["16.30", "Harry Potter Studio Tour", "Warner Bros. Studio Tour. Allerede booket.", "Gå til London Bridge. Tag Northern Line til Euston. Tag tog til Watford Junction. Tag shuttlebus til Warner Bros. Studio Tour.", "Afgang fra hotellet senest ca. 14.30. Ankomst tidligst kl. 16.10. Shuttlebus fra Watford Junction tager ca. 15 minutter og kører mindst hver halve time. Digitale billetter klar på mobilen.", [["Transport", "hp"], ["Kort", "map:Warner Bros Studio Tour London"]], "Booket"]
      ]
    },
    {
      id: "d14",
  ...
  practical: [
    ...
    ["Nærmeste store station", "London Bridge. Bruges til Gatwick, Tube, tog mod Greenwich og adgang til resten af byen. Efter ankomst går vi til London Bridge Underground og køber Oyster til den 12-årige, får Young Visitor discount lagt på og fylder ca. £10 på. Zone 1-2 er fint til de almindelige London-ture.", [["Oyster", "tflOyster"], ["Young Visitor", "tflYoung"]]],
    ...
    ["Offentlig transport", "Voksne bruger contactless/pay as you go. Hver voksen skal bruge sit eget kort eller sin egen telefon og bruge samme kort/enhed hele dagen, så capping virker korrekt. Den 10-årige rejser gratis med betalende voksen på TfL-transport i London. Den 12-årige får almindeligt Oyster med Young Visitor discount, som giver halv voksenpris og lavere dagsloft i op til 14 dage. Barnet skal være med, når rabatten lægges på. Fyld kun ca. £10 på først; der kan toppes op, og ubrugt pay as you go-credit kan refunderes. Gatwick og Watford/Harry Potter ligger uden for den almindelige zone 1-2-plan og håndteres særskilt. Ugekort til den 12-årige kan ikke betale sig i vores program: 7 Day Travelcard zone 1-2 koster £22.40, mens dagsloftet for 11-15-årige i zone 1-2 er £4.45 peak og £1.90 off-peak, og flere af vores dage er gang, korte ture eller ture uden for zonen.", [["Young Visitor", "tflYoung"], ["Oyster", "tflOyster"], ["11-15-priser", "tflChildFares"], ["Travelcards", "tflTravelcard"]]],
    ["Apps", "Der er ikke behov for særlige apps til billettering. Google Maps eller Apple Maps er nok til de fleste ture. TfL Go kan bruges som supplement til ruteplanlægning."],
