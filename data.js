window.LONDON_DATA = {
  ...
  days: [
    ...
    },
    {
      ...
      c: "d11",
      items: [
        ["Formiddag", "Oyster og City of London", "Køb et almindeligt Oyster ved London Bridge Underground og få Young Visitor discount lagt på. Gå derefter over London Bridge og fortsæt via City-dragerne, Monument, Leadenhall Market, Bank of England og Royal Exchange.", "Alt klares til fods.", "City-dragerne markerer indgangene til City of London.", [["Oyster", "tflOyster"], ["Leadenhall Market", "leadenhall"], ["Kort", "map:City of London Dragon London Bridge"]]],
        ["Middag", "Bus 15, Temple Bar-dragen og St Paul’s", "Tag bus 15 fra stoppested MA, Cannon St Stn / Bank Station, mod Trafalgar Square. Stå af ved The Royal Courts of Justice, stoppested P. Se Temple Bar-dragen og gå tilbage ad Fleet Street til St Paul’s Cathedral.", "Bus 15 bruges som sightseeing og transport gennem City. Resten klares til fods.", "St Paul’s ses udefra.", [["TfL rute 15", "bus15"], ["Påstigning", "map:Cannon St Stn Bank Station Bus Stop MA London"], ["Kort", "map:Temple Bar Dragon Royal Courts of Justice London"], ["St Paul’s", "map:St Pauls Cathedral London"]]],
    ...
    },
    {
      ...
      items: [
        ...
        ["13.30", "Wonderlab på Science Museum", "Gratis adgang til Science Museum er booket til kl. 13.00. Vi forventer at ankomme omkring kl. 13.20 og går direkte til Wonderlab på niveau 3.", "Fra Sky Garden: gå til Monument og tag District Line direkte til South Kensington. Følg skiltene mod museerne og gå til Science Museum.", "Wonderlab er booket for alle fire. Adgangsvinduet er kl. 13.30-14.25; det er ikke en sluttid. Science Museums øvrige gallerier ses bagefter.", [["Wonderlab", "wonder"], ["Science Museum", "science"], ["Kort", "map:Science Museum London"]], "Booket"],
  ...
  alternatives: [
    ...
    ["Westminster Abbey", "Stor London-klassiker ved Big Ben og Westminster. Bedst som kig udefra i dette program; indendørs besøg er betalt og kun relevant, hvis der virkelig er ekstra tid og lyst.", "https://www.westminster-abbey.org/visit-us/", "map:Westminster Abbey London"],
    ["St Paul’s Cathedral", "Passer naturligt sammen med South Bank, Tate Modern og Millennium Bridge. Bedst som kig udefra; indendørs besøg og kuppel er betalt og kun relevant ved ekstra tid.", "https://www.stpauls.co.uk/visit-us", "map:St Pauls Cathedral London"],
